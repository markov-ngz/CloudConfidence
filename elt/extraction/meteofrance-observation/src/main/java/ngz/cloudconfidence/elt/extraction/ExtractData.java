...
import ngz.etl.filesource.adapter.meteofrance.observation.MeteoFranceObsFileSourceFactory;
...
public class ExtractData {
    ...
    public static void main(String[] args) {
        try {
            ...
            FileSourceFactory sourceFactory = new MeteoFranceObsFileSourceFactory();
