package ngz.cloudconfidence.convertgrib2.airflow;
...
public class XcomUtils {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(XcomUtils.class);
    ...
    public static void pushXcom(Object data, boolean success, String filePath) {
        ...
        LOG.info("Successfully wrote XCom to: {}", filePath);
        LOG.info("Payload: {}", rootNode);
    }
}
